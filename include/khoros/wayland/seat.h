...
constexpr uint32_t KHR_KEY_1                 = 2;
constexpr uint32_t KHR_KEY_2                 = 3;
constexpr uint32_t KHR_KEY_3                 = 4;
constexpr uint32_t KHR_KEY_4                 = 5;
constexpr uint32_t KHR_KEY_0                 = 11;
constexpr uint32_t KHR_KEY_W                 = 17;
constexpr uint32_t KHR_KEY_E                 = 18;
constexpr uint32_t KHR_KEY_R                 = 19;
constexpr uint32_t KHR_KEY_T                 = 20;
...
constexpr uint32_t KHR_KEY_G                 = 34;
constexpr uint32_t KHR_KEY_K                 = 37;
...
typedef struct {
    ...
    bool     t_pressed;
    bool     e_pressed;
    int32_t  spawn_mesh_pressed; /* -1 if none, 0..4 for mesh id */
    bool     w_down;
    bool     a_down;
    bool     s_down;
    bool     d_down;
