...
extern bool test_capsule_capsule_collision(void);
extern bool test_capsule_aabb_collision(void);
extern bool test_multi_shape_full_pairwise_coverage(void);
...
int main(void) {
    ...
    RUN_TEST(&stats, test_capsule_capsule_collision);
    RUN_TEST(&stats, test_capsule_aabb_collision);
    RUN_TEST(&stats, test_multi_shape_full_pairwise_coverage);
